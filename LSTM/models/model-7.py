...
m = Model(folderName, 'x-1-second-seqLen-600.h5', 'y-1-second-seqLen-600.h5')
...
model.add(Conv2D(256, kernel_size=(3, 3), activation='relu', input_shape=(m.seqLen, m.nInputFeatures, 1), data_format='channels_last'))
